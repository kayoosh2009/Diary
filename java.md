# 12.11.2025 - Символы и String
Как сравнивать str в java? <br>
equals - это функция которая позволяет сравнивать текст ( НИКОГДА НЕ ПОЛЬЗУЙСЯ == ДЛЯ СРАВНЕНИЯ, ЭТО ОШИБКА !!! )
```java
if (str1.equals(str2)){
